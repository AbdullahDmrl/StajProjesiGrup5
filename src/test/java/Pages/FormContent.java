...
public class FormContent  extends Parent{
    ...
    public void findAndClick(String elementName)
    {
        switch (elementName) {
            ...
            case "employeeTeacher":myElement = employeeTeacher;break;
            case "documentType":myElement = documentType;break;
            case "passport":myElement = passport;break;
            case "passiveButton":myElement = passiveButton;break;
    ...
    public void findAndSend(String elementName,String value)
    {
        switch (elementName) {
            ...
            case "inputEmployeeName":myElement = inputEmployeeName;break;
            case "inputEmployeeLastName":myElement = inputEmployeeLastName;break;
